...
<html>
	...
	<body>
		<?php 
			...
			$strQuery = "SELECT * FROM instruktur WHERE id_instruktur = '$id'";
		...
		?>
		 ...
		 <form action="instruktur_edit_update.php" method="post">
		 	<!-- Label Form -->
		 	<h3>Form Edit Peserta</h3>

		 	<!-- Sembunyikan ID instruktur-->
		 	<input type="hidden" name="lblId" value="<?php echo $id; ?>">

		 	<!-- Field Table instruktur-->
		 	<table>
			<tr>
		...
		<?php 
		 ...
		 <a href="list_instruktur.php">Kembali ke List Peserta</a>
