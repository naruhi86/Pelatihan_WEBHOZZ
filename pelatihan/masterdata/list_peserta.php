...
<html>
	...
	<body>
		...
		<h4>Master data | LIST PESERTA</h4>

		<table class="table table-striped">
			<a href="peserta_baru.php">Buat data baru</a>
			<tr>
				<td>ID Peserta</td>
				<td>Nama</td>
				<td>Tanggal Lahir</td>
			...
			<tr>
				...
				<td>
					<a href="peserta_edit.php?id= <?php echo $id; ?>">Edit</a> |
					<a href="peserta_delete.php?id= <?php echo $id; ?>" onclick="return confirm('Yakin mau hapus <?php echo $nama; ?> ?')">
						Hapus
					</a>
				</td>
			</tr>
